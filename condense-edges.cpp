...
void dump_cluster_graph_in_METIS(int n_clusters, int *cluster_graph, std::string output_graph_file) {
    int total_edges = 0;
...
int main(int argc, char** argv) {
    ...
    int *cluster_graph = (int*) calloc( n_clusters * n_clusters, sizeof(int) );
    ...
    dump_cluster_graph_in_METIS(n_clusters, cluster_graph, output_graph_file);
    return 0;
}
